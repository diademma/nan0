...
/**
 * Исправленная версия с прямым обращением к найденным ID элементов Gmail Touch:
 * composeto, cmcsubj, cmcbody.
 */
public class MainActivity extends AppCompatActivity {
    ...
    private void injectFillCompose(String text) {
        ...
        String js = "javascript:(function(){"
                ...
                // Приоритетные селекторы Touch-интерфейса Google по найденным ID на первом месте
                + "var toSelectors=["
                + "  '#composeto',"
