 ...
 * Имитирует физические события ввода символов на клавиатуре для триггера автосохранения
 * и нажимает на штатную кнопку Gmail Touch Back (id="cmcb") для корректного закрытия формы.
 */
public class MainActivity extends AppCompatActivity {
    ...
    private void injectFillCompose(String text) {
        ...
        workerWebView.evaluateJavascript(js, new ValueCallback<String>() {
            ...
            public void onReceiveValue(String value) {
                ...
                // Даем Gmail 2.5 секунды на отправку запроса и плавный переход в черновики
                handler.postDelayed(() -> {
    ...
    private void verifySavedDraft() {
        ...
        // Гарантированно перезагружаем черновики
